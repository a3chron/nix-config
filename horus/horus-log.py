...
def parse(entry):
    ...
    for prefix, label in [
        ...
        ("timeout: ", None),
        ("chime failed", None),
        ("audio started this round", "audio is the answer — TTS skipped"),
        ("round ended with audio playing", "round ended with audio playing"),
        ...
        ("TTS engine gone", "reading paused — TTS engine down"),
        ("TTS engine back", "reading resumed — TTS engine back"),
        ("playback outran synthesis", "reading paused — synthesis underrun"),
        ("mpv is gone", "reading parked — player died"),
        ("paused from outside", "reading paused from the media key"),
        ("resumed from outside", "reading resumed from the media key"),
