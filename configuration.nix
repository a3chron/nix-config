...

{
  ...
  users.users.a3chron = {
    isNormalUser = true;
    description = "a3chron";
    extraGroups = [ "networkmanager" "wheel" "plugdev" "docker" "i2c" ];
  ...
  # Import packages to keep it clean here
  ...
  # Or disable the firewall altogether. (For me to keep wifi hotspot working)
